...
<PageWrapper>
    ...
    <div class="content-wrapper">
        ...
        <p class="text--sm">
            Since the particiapants do not know which type of sample they are tasting they must record their sample
            rankings based on the order in which they are given
        </p>
        <h3>Example</h3>
        <p class="text--sm">
            Billy is participating in a taste test with 3 samples. Billy liked the first sample the least and liked the
            second sample the best. Billy should hand in:
        </p>
        <p class="text--sm">
            1<sup>st</sup> - 2<br />
            2<sup>nd</sup> - 3<br />
    ...
    <div class="button-wrapper">
        <Link to="/confirm" class="btn-secondary">Back</Link>
